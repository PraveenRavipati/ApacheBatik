...
public class StaticRenderer implements ImageRenderer {
    ...
    public void repaint(Shape area) {
        ...
        System.out.println("Rectlist size : " + rlm.size());
    ...
    protected void updateWorkingBuffers() {
        if (rootFilter == null) {
        	//System.out.println("Graphical Node : " + rootGN);
            rootFilter = rootGN.getGraphicsNodeRable(true);
            //System.out.println("root Filter : " + rootFilter);
            rootCR = null;
        }
        ...
        if ((workingBaseRaster == null) ||
            ...
            System.out.println("Writing base raster : " + workingBaseRaster.toString());
        }
