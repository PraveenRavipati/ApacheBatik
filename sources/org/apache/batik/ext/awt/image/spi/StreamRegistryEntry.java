...
public interface StreamRegistryEntry extends RegistryEntry {
    ...
    //Praveen implementation for interpolation
    /**
     * This is to implement interpolation algorithm to the downloaded image
     * @param toHeight
     * @param toWidth
     * @param canScale
     */
    void scaleTo(long toHeight, long toWidth, int intepolationType);
