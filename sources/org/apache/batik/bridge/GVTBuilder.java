...
public class GVTBuilder implements SVGConstants {
    ...
    public GraphicsNode build(BridgeContext ctx, Document document) {
        ...
        try {
            ...
            //System.out.println("gnBridge : " + gnBridge);
    ...
    protected void buildComposite(BridgeContext ctx,
        ...
        for (Node n = e.getFirstChild(); n != null; n = n.getNextSibling()) {
            if (n.getNodeType() == Node.ELEMENT_NODE) {
                ...
                //System.out.println("Element : " + e.getLocalName() + " Node n : " + n.getLocalName() + " Node Type : " + n.getNodeType());
                if("image".equalsIgnoreCase(n.getLocalName())){
                	if(n instanceof SVGOMImageElement){
                		SVGOMImageElement element = (SVGOMImageElement) n;               		
                		//System.out.println("Height : " + element.getHeight() + " Width : " + element.getWidth());
                	}
